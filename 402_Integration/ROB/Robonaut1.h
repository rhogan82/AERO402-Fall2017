...
#include "Robonaut1.generated.h"
class ROB_Power;
UCLASS()
class MYPROJECT4_API ARobonaut1 : public AActor
{
	GENERATED_BODY()
...
public:
	...
	float a;
	float b;
	ROB_Power* Power_Level; 	//starts point for PowerLevel class
	double powerlevel;			//Power level of the robonaut (W)
	bool movement; 				//checks to see if robonaut moves
protected:
